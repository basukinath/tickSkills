...
public interface QuestionsService {
    ...
    Page<Question> list(String categoryName, String difficulty, String source, String tagName, String search, Pageable pageable);
    ...
    BulkImportResultDTO bulkImportQuestions(List<BulkImportQuestionDTO> questions);
}
